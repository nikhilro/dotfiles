...
#^e::
  ...
  if(Style & 0xC00000) { ; if has WS_CAPTION. Ignore sizebox value.
    ...
    WinSet, Style, -0xC00000, A ; removes attributes, including sizebox...doesn't do a strict subtraction
    WinMove,A,,(A_ScreenWidth/2) - 7, -28, (A_ScreenWidth/2) + 22, A_ScreenHeight + 32
  } else {
